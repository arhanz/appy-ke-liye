  ...
  const createCustomerHandler = (e) => {
    ...
    signUpCustomer(payload)
      .then((res) => {
        ...
        setSignUpStatus({
          status: "success",
          msg: "Please! Login to confirm your booking. Redirecting...",
        });
    ...
    <div>
      <Modal open={signup} onClose={handleClose}>
        ...
        >
          ...
          {signUpStatus.status && (
            <Alert className="w-100 mb-4" severity={signUpStatus.status}>
              {" "}
              {signUpStatus.msg}{" "}
            </Alert>
          )}{" "}
