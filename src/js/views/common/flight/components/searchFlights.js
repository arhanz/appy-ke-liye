  ...
  return (
    <>
      <form className="container mt-4" onSubmit={searchHandler}>
        ...
        <div
          className="row col-lg-9 mt-3 mb-1"
          style={{
            fontSize: 16,
          }}
        >
          ...
          <>
            ...
            <div className="container pt-3">
              ...
              {offers.map((o, i) => {
                return (
                  <FlightCard
                    setFlightRender={setFlightRender}
                    adult={adultFromParams !== null ? adultFromParams : adult}
                    children={
                      childrenFromParams !== null
                        ? childrenFromParams
                        : children
                    }
                    infant={
                      infantFromParams !== null ? infantFromParams : infant
                    }
                    from={offersFrom}
                    to={offersTo}
                    data={o}
