...
function Bookings() {
    ...
    useEffect(() => {
        ...
        if (bookingDetails && bookingType) {
            ...
            if (bookingType === "Air") {
                const makeReturnDate = new Date(
                    bookingDetails.itineraries[0]?.segments[0]?.departure?.dateTime
                );
                makeReturnDate.setDate(makeReturnDate.getDate() + 1);
                enqueueSnackbar("Flight Booking in Progress.", {
                    variant: "info",
                });
                let bookingDetail = {
                ...
                if (bookingDetails.itineraries[1]?.segments[0]?.departure?.dateTime) {
                    bookingDetail.returnDate =
                        bookingDetails.itineraries[1]?.segments[0]?.departure?.dateTime;
                } else {
                ...
                enqueueSnackbar("Hotel Booking in Progress.", {
                    variant: "info",
                });
                ...
                enqueueSnackbar("Travel Package Booking in Progress.", {
                    variant: "info",
                });
