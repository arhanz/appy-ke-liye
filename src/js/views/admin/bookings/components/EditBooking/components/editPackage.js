...
export default function ViewPackage({
    ...
    const submitHandler = (e) => {
        ...
        bookPackage(payload)
            .then((res) => {
                ...
                enqueueSnackbar("Success, New Booking Created.", {
                    variant: "success",
                });
            ...
            .catch((error) => {
                if (error.response.status === 401) {
                    ...
                    // if (payload.bookingDetail.checkinDate != new Date()) {
                    //   enqueueSnackbar("The date must be greater than now.", {
                    //     variant: "warning",
                    //   });
                    // } else {
                    enqueueSnackbar("Unable to book package.", {
                        variant: "error"
                    });
                    // }
                }
    ...
    return ( <
        ...
        Select labelId = "activities-label"
        id = "activities"
        multiple value = {
            activities
        }
        ...
        Go Back <
        /Button> { /* {state.showList && <Bookings />} */ } <
        Button style = {
            {
                width: "32%"
            }
