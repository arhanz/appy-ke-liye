...
export default function EditPackage({
    ...
    const updatePackageHandler = (e) => {
        ...
        // if (agencies.length) payload["_agencies"] = agencies;
        ...
        updateSpecificPackage(id, payload)
            ...
            .catch((error) => {
                if (error.response.status === 401) {
                    ...
                    console.log(error.response.data);
                    console.log(error.response.status);
                    enqueueSnackbar("Unable to update package.", {
                        variant: "error"
                    });
                }
                dispatch(unsetLoading());
    ...
    const deleteHandler = () => {
        ...
        deletePackage(id)
            .then((res) => {
                // console.log(res.data)
                enqueueSnackbar("Package delete successfully.", {
                    variant: "success"
                });
                dispatch(unsetLoading());
                setRender("all");
            ...
            .catch((error) => {
                if (error.response.status === 401) {
                    ...
                    console.log(error.response.data);
                    console.log(error.response.status);
                    enqueueSnackbar("Unable to delete package.", {
                        variant: "error"
                    });
                }
                dispatch(unsetLoading());
    ...
    return ( <
        ...
        <
        InputLabel id = "select-agencies-field" >
        Select Agencies <
        /InputLabel> <
        Select labelId = "select-agencies-field"
        multiple value = {
            agencies
        }
        onChange = {
        ...
        FormControl className = "mt-4 w-100" >
        <
        InputLabel id = "select-activities-field" >
        Select Activities <
        /InputLabel> <
        Select labelId = "select-activities-field"
        multiple value = {
            activities
        }
        onChange = {
        ...
        FormControl className = "mt-4 w-100" >
        <
        InputLabel id = "select-tags-field"
        required >
        Select Tags <
        /InputLabel> <
        Select labelId = "select-tags-field"
        multiple value = {
            tags
        }
        onChange = {
        ...
        <
        InputLabel id = "select-status-field"
        required >
        Select Status <
        /InputLabel> <
