        ...
        <div className="d-flex mb-2 justify-content-between align-items-end">
          <div>
            ...
            >
              {" "}
              {`Type: ${
                data?.selectedOffer?.itineraries?.length === 2
                  ? "Return"
                  : "One Way"
              }`}{" "}
            </p>{" "}
            {checkIndirect(data?.selectedOffer?.itineraries) && (
              <p
                className="m-0"
                style={{
                  fontWeight: "bold",
          ...
          <div>
            ...
            >
              {" "}
              {`Passenger: ${
                parseInt(data?.bookingDetail?.adults) +
                parseInt(data?.bookingDetail?.children) +
                parseInt(data?.bookingDetail?.infants)
              }`}{" "}
            </p>{" "}
            <p
              className="m-0"
