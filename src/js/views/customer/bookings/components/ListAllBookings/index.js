...
export default function ListAllBookings({
  reload,
  setType,
  setReload,
  setRender,
    ...
    <div>
      ...
      <TableContainer component={Paper}>
        <Table className={classes.table} aria-label="simple table">
          <TableHead className="zokiBgBlack">
            <TableRow>
              <TableCell
                style={{
                  color: "white",
                ...
                >
                  <TableCell component="th" scope="row">
                    <ListItem className="pl-0">
                      <ListItemText primary={bkg._bookingId} />{" "}
                    </ListItem>{" "}
                  </TableCell>{" "}
                  <TableCell component="th" scope="row">
                    <ListItem className="pl-0">
                      <ListItemText primary={bkg.lob} />{" "}
                    </ListItem>{" "}
                  </TableCell>{" "}
                  ...
                  <TableCell align="right">
                    <Chip
                      ...
                      label={
                        <Moment format="DD/MM/YYYY">
                          {" "}
                          {bkg.bookingDetail.checkoutDate}{" "}
                        </Moment>
                      }
                    />{" "}
                  </TableCell>{" "}
